...
INSERT INTO `products` (`img_path`, `name`, `author_id`, `isbn`, `genre_id`, `house_id`, `price`, `sales`) 
VALUES ("american_marxism.png", "American Marxism", 1, "9781501135972", 1, 1, 50000, 1),
("cryinginhmart.jpeg", "Crying in H Mart", 2, "9780525657743", 2, 2, 70500, 1),
("educated.jpeg", "Educated: A Memoir", 3, "9780099511021", 3, 3, 30000, 1),
("harlem_shuffle.jpeg", "Harlem Shuffle", 4, "0385545134", 4, 4, 9000, 1),
("Hillary_clinton.png", "State of Terror", 5, "9783749903276", 5, 5, 20000, 1),
("people_we_meet.png", "People We Meet on Vacation", 6, "9781984806758", 6, 6, 30000, 1),
("peril.jpg", "Peril", 7, "9781982182915", 7, 7, 70500, 1),
("theartofnot.jpg", "The Subtle Art of Not Giving a F*ck", 8, "9780062641540", 8, 8, 23200, 1),
("theworldtravel.jpg", "World Travel: An Irreverent Guide", 9, "9781526630216", 9, 9, 90000, 1),
("think_again.jpeg", "Think Again: The Power of Knowing What You Don't Know", 10, "9780593298749", 10, 10, 65000, 1)
